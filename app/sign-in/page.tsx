    ...
    <main className="auth-page">
      <section className="auth-panel">
        ...
        <div className="auth-heading">
          ...
          <h1>Sign in</h1>
          <p>Reconnect to your WZPRO Meta account with email/password or OAuth.</p>
        </div>
        ...
        <div className="auth-actions">
          <EmailSignInForm initialMode="signin" allowSwitch={false} />
          <p className="email-auth-switch">
            No account yet? <Link href="/sign-up">Sign up</Link>
          </p>
          <div className="auth-separator">Or</div>
          <SupabaseOAuthButtons intent="signin" />
        </div>

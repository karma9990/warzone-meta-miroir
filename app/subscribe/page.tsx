      ...
      <main className="sub-main">
        ...
        {submitted ? (
          <div className="sub-success">
            ...
            <Link href="/pro-tools" className="sub-cta sub-cta--back">
              BACK TO TOOLS
            </Link>
          </div>
        ) : (
          <form className="sub-form" onSubmit={handleSubmit} noValidate>
            <div className="sub-field">
              ...
              <input
                ...
                autoComplete="email"
              />
              {error && <span className="sub-error">Invalid email address.</span>}
            </div>
            ...
            <button type="submit" className="sub-cta sub-cta--free">
              JOIN FOR FREE
            </button>
        ...
        <div className="sub-upgrade">
          ...
          <Link href="/pro-access" className="sub-upgrade-link">
            Upgrade to Pro →
          </Link>
        </div>
      </main>
